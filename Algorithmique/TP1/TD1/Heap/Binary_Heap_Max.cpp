...
size_t Binary_Heap_Max::parent(size_t i) { return (i - 1) / 2; }

size_t Binary_Heap_Max::left_child(size_t i) { return 2 * i + 1; }

size_t Binary_Heap_Max::right_child(size_t i) { return 2 * i + 2; }
