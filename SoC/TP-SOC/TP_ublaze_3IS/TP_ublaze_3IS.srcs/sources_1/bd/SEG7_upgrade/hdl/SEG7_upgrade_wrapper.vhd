...
--Command     : generate_target SEG7_upgrade_wrapper.bd
--Design      : SEG7_upgrade_wrapper
...
entity SEG7_upgrade_wrapper is
  port (
...
end SEG7_upgrade_wrapper;

architecture STRUCTURE of SEG7_upgrade_wrapper is
  component SEG7_upgrade is
  port (
    sys_clock : in STD_LOGIC;
    usb_uart_rxd : in STD_LOGIC;
    usb_uart_txd : out STD_LOGIC;
...
begin
SEG7_upgrade_i: component SEG7_upgrade
     port map (
